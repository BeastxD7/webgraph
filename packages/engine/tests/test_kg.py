...
class TestVerification:
                    ...
                    "attributes": [
                        {
                            ...
                            "unit": "INR/year",
                            "block": "b0",
                            "quote": "is ₹1,20,000 per year",
                        }
                    ],
                    "mentions": [
                        {"block": "b0", "quote": "The tuition fee for B.E. Computer Science"}
                    ],
                }
            ],
            "relations": [],
    ...
    def test_a_fabricated_quote_is_rejected_and_counted(self, graph: SiteGraph) -> None:
        ...
        payload = {
                    ...
                    "attributes": [
                        {
                            ...
                            "unit": "INR",
                            "block": "b0",
                            "quote": "The tuition fee is ₹1,50,000 per year",
                        }
                    ],
            ...
            "relations": [
                {
                    "subject": "B.E. Computer Science",
                    "predicate": "offered_by",
                    "object": "B.E. Computer Science",
                    "fact": "x",
                    "evidence": [{"block": "b0", "quote": "not on this page at all"}],
                }
            ],
        }
        out = verify(payload, prepared)
            ...
            "entities": [
                {
                    ...
                    "mentions": [
                        {
                            "block": "b0",
                            "quote": "The tuition fee for M.Tech Data Science is ₹95,000 per year",
                        }
                    ],
                }
            ],
            ...
            "relations": [
                {
                    ...
                    "object": "B",
                    "fact": "f",
                    "evidence": [{"block": "b0", "quote": "tuition fee"}],
                }
            ],
        }
        out = verify(payload, prepared)
    ...
    def test_locate_quote_is_exact_after_normalisation_only(self) -> None:
        ...
        assert locate_quote(block, 'Visit the admissions page - it opens "Monday".') == (
            0,
            block.index(".") + 1,
        )
        assert locate_quote(block, "Second line.") == (block.index("Second"), len(block))
        assert (
            locate_quote(block, "Visit the admission page") is None
        )  # a changed word is not a match
        assert locate_quote(block, "") is None

    def test_scripted_fabrication_through_the_provider_yields_nothing(
                        ...
                        "entities": [
                            {
                                ...
                                "attributes": [],
                                "mentions": [
                                    {"block": "b0", "quote": "SVIT charges nothing at all"}
                                ],
                            }
                        ],
                        "relations": [],
            ...
            "entities": [
                {
                    ...
                    "aliases": [],
                    "attributes": [],
                    "mentions": [{"block": "b0", "quote": "Prof. Kiran Shetty"}],
                },
                {
                    "name": "M.Tech Data Science",
                    "type": "Course",
                    "aliases": [],
                    "attributes": [],
                    "mentions": [{"block": "b0", "quote": "M.Tech Data Science"}],
                },
            ],
            "relations": [
                {
                    "subject": "M.Tech Data Science",
                    "predicate": "Taught By",
                    "object": "Prof. Kiran Shetty",
                    "fact": "f",
                    "evidence": [
                        {"block": "b0", "quote": "The programme coordinator is Prof. Kiran Shetty"}
                    ],
                }
            ],
        }
...
class TestMerge:
                ...
                "entities": [
                    {
                        ...
                        "aliases": [],
                        "attributes": [],
                        "mentions": [{"block": "b0", "quote": "Dr. Anita Rao is the Head"}],
                    }
                ],
                "relations": [],
            },
                ...
                "entities": [
                    {
                        ...
                        "aliases": [],
                        "attributes": [],
                        "mentions": [{"block": "b0", "quote": "convened by Dr. Anita Rao"}],
                    }
                ],
                "relations": [],
            },
    ...
    def test_a_declared_alias_merges_a_later_name(self, graph: SiteGraph) -> None:
        a = _extracted(
            ...
            "Dr. Anita Rao",
            {
                "entities": [
                    {
                        "name": "Sode Valley Institute of Technology",
                        "type": "Organization",
                        "aliases": ["SVIT"],
                        "attributes": [],
                        "mentions": [
                            {"block": "b0", "quote": "Sode Valley Institute of Technology"}
                        ],
                    }
                ],
                "relations": [],
                ...
                "entities": [
                    {
                        ...
                        "aliases": [],
                        "attributes": [],
                        "mentions": [{"block": "b0", "quote": "joined SVIT in 2009"}],
                    }
                ],
                "relations": [],
            },
    ...
    def test_open_type_joins_core_type_but_core_types_stay_apart(self, graph: SiteGraph) -> None:
        ...
        merger = Merger()
        merger.add_extracted(
            one("Dr. Anita Rao", "Dr. Anita Rao", "Faculty", "Dr. Anita Rao is the Head")
        )
        merger.add_extracted(
            one("TechFest 2026", "Dr. Anita Rao", "Person", "convened by Dr. Anita Rao")
        )
        merger.add_extracted(
            one(
                "Contact us",
                "Sode Valley Institute of Technology",
                "Organization",
                "Sode Valley Institute of Technology, Sode Valley Road",
            )
        )
        merger.add_extracted(
            one(
                ...
                "Sode Valley Institute of Technology",
                "Place",
                "at Sode Valley Institute of Technology",
            )
        )
        result = merger.finish()
        types = sorted((e.type, e.name) for e in result.entities.values())
        assert types == [
            ("Organization", "Sode Valley Institute of Technology"),
            ("Person", "Dr. Anita Rao"),
            ("Place", "Sode Valley Institute of Technology"),
        ]
    ...
    def test_near_duplicates_merge_at_jaccard_point_nine(self, graph: SiteGraph) -> None:
        assert (
            jaccard(
                shingles("Sode Valley Institute of Technology"),
                shingles("Sode Valley Institute of Technology."),
            )
            >= 0.9
        )
            ...
            "entities": [
                {
                    ...
                    "aliases": [],
                    "attributes": [],
                    "mentions": [{"block": "b0", "quote": "Sode Valley Institute of Technology"}],
                },
                {
                    "name": "Sode Valley  Institute of Technology,",
                    "type": "Organization",
                    "aliases": [],
                    "attributes": [],
                    "mentions": [{"block": "b0", "quote": "Institute of Technology"}],
                },
            ],
            "relations": [],
        }
    ...
    def test_structured_data_enters_first_and_wins_the_type(self, graph: SiteGraph) -> None:
        ...
        assert len(rao) == 2, (
            "a core-type conflict stays two entities; the structured one keeps Person"
        )
        ...
        assert all(m.evidence.block_xpath for m in structured.mentions), (
            "structured entities cite the block that names them"
        )
    ...
    def test_merge_is_deterministic_across_runs(self, graph: SiteGraph, tmp_path: Path) -> None:
        def build() -> dict:
            ...
            list(
                KGBuilder(
                    graph, FakeProvider(), store, build_config=BuildConfig(concurrency=3)
                ).run()
            )
            return {
                "entities": sorted(
                    (e.id, e.type, e.name, tuple(e.aliases), e.evidence_count)
    ...
    def test_generic_names_are_flagged(
        self, built: tuple[KGStore, FakeProvider, list[dict]]
    ) -> None:
        store, _, _ = built
        svit = next(
            e for e in store.iter_entities() if e.name == "Sode Valley Institute of Technology"
        )
...
class TestStore:
    def test_round_trip_keeps_every_row(
        self, built: tuple[KGStore, FakeProvider, list[dict]]
    ) -> None:
    ...
    def test_fts_query_survives_punctuation(
        ...
        assert (
            fts_query('What is "the" fee: for B.E.? -x')
            == '"What" OR "is" OR "the" OR "fee" OR "for"'
        )
    ...
    def test_llm_cache_round_trip(self, store: KGStore) -> None:
        ...
        assert (text, usage.input_tokens, usage.output_tokens, model) == (
            '{"entities": [], "relations": []}',
            10,
            2,
            "m",
...
class TestBuild:
    def test_estimate_comes_first_and_before_any_call(
        self, graph: SiteGraph, store: KGStore
    ) -> None:
        fake = FakeProvider()
        ...
        assert first["input_tokens"] > 1000 and first["output_tokens"] == int(
            first["input_tokens"] * 0.25
        )
    ...
    def test_build_counts_and_events(self, built: tuple[KGStore, FakeProvider, list[dict]]) -> None:
        ...
        assert all(
            set(e) >= {"page", "section_id", "accepted", "rejected", "rejected_reasons", "cached"}
            for e in section_events
        )
        assert store.last_run()["entities"] == stats["entities"]

    def test_second_build_hits_the_cache_and_makes_no_calls(
        self, built: tuple[KGStore, FakeProvider, list[dict]], graph: SiteGraph
    ) -> None:
        store, _, first = built
        fake = FakeProvider()
        events = list(KGBuilder(graph, fake, store).run())
    ...
    def test_rebuild_ignores_the_cache(
        self, built: tuple[KGStore, FakeProvider, list[dict]], graph: SiteGraph
    ) -> None:
        store, _, _ = built
        fake = FakeProvider()
    ...
    def test_token_cap_stops_the_build_cleanly(self, graph: SiteGraph, store: KGStore) -> None:
        ...
        events = list(
            KGBuilder(
                graph, fake, store, build_config=BuildConfig(max_input_tokens=1500, concurrency=1)
            ).run()
        )
        budget = [e for e in events if e["type"] == "budget"]
        assert (
            budget
            and budget[0]["reason"] == "max_input_tokens"
            and budget[0]["remaining_sections"] > 0
        )
        done = events[-1]
    ...
    def test_usd_cap_stops_the_build(self, graph: SiteGraph, store: KGStore) -> None:
        fake = FakeProvider(
            ProviderConfig(
                provider="fake", model="fake-1", price_per_m_in=1000.0, price_per_m_out=1000.0
            )
        )
        events = list(
            KGBuilder(
                graph, fake, store, build_config=BuildConfig(max_usd=0.005, concurrency=1)
            ).run()
        )
    ...
    def test_page_and_section_caps(self, graph: SiteGraph, store: KGStore) -> None:
        events = list(
            KGBuilder(graph, FakeProvider(), store, build_config=BuildConfig(max_pages=2)).run()
        )
        assert events[0]["pages"] == 2 and events[0]["skipped"]["page_cap"] > 0
        events = list(
            KGBuilder(graph, FakeProvider(), store, build_config=BuildConfig(max_sections=3)).run()
        )
    ...
    def test_a_graph_without_block_refs_is_skipped_not_cited(
        self, graph: SiteGraph, store: KGStore
    ) -> None:
        ...
        stripped = SiteGraph(
            ...
            sections={k: replace(s, blocks=()) for k, s in graph.sections.items()},
        )
    ...
    def test_should_stop_ends_the_build(self, graph: SiteGraph, store: KGStore) -> None:
        events = list(
            KGBuilder(
                ...
                FakeProvider(),
                store,
                build_config=BuildConfig(concurrency=1),
...
class TestRetrieve:
    def test_path_is_streamed_in_order_and_answer_cites_url_xpath(
        self, built: tuple[KGStore, FakeProvider, list[dict]], graph: SiteGraph
    ) -> None:
        store, fake, _ = built
        events = list(
            KGRetriever(store, fake, graph=graph).ask(
                "What is the tuition fee for B.E. Computer Science?"
            )
        )
        kinds = [e["type"] for e in events]
        ...
        assert all(
            i["anchor"] == f"{i['url']}#{i['xpath']}" and i["xpath"].startswith("/html/")
            for i in evidence["items"]
        )
        answer = events[-1]
        assert answer["citations"] and all(
            c["anchor"].startswith("https://kg-fixture.test/") for c in answer["citations"]
        )
    ...
    def test_generic_entities_are_not_expanded_through(
        self, built: tuple[KGStore, FakeProvider, list[dict]], graph: SiteGraph
    ) -> None:
        store, fake, _ = built
        svit = next(e for e in store.iter_entities() if e.generic)
        events = list(
            KGRetriever(store, fake, graph=graph).retrieve("Sode Valley Institute of Technology")
        )
    ...
    def test_uncited_sentences_are_flagged_never_dropped(
        self, built: tuple[KGStore, FakeProvider, list[dict]], graph: SiteGraph
    ) -> None:
        store, _, _ = built
        fake = FakeProvider(
            scripted=[
                "The fee is ₹1,20,000 per year [1]. The campus has a swimming pool. It also has a lake [99]."
            ]
        )
        answer = list(
            KGRetriever(store, fake, graph=graph).ask("tuition fee B.E. Computer Science")
        )[-1]
        flags = [(s["text"][:20], s["unsupported"]) for s in answer["sentences"]]
        assert flags == [
            ("The fee is ₹1,20,000", False),
            ("The campus has a swi", True),
            ("It also has a lake [", True),
        ]
    ...
    def test_parse_answer_keeps_abbreviations_together(self) -> None:
        ...
        answer = parse_answer(
            "Dr. Anita Rao heads the B.E. Computer Science programme [1]. It costs ₹1,20,000 [2].",
            cites,
            QueryPath(),
        )
    ...
    def test_no_provider_gives_an_extractive_answer(
        self, built: tuple[KGStore, FakeProvider, list[dict]], graph: SiteGraph
    ) -> None:
        store, _, _ = built
        ...
        assert (
            all(len(s["citations"]) == 1 for s in answer["sentences"])
            and answer["unsupported"] == 0
        )
...
class TestExport:
    ...
    def test_cypher_is_merge_only_and_escapes_quotes(
        self, built: tuple[KGStore, FakeProvider, list[dict]]
    ) -> None:
        store, _, _ = built
    ...
    def test_jsonld_carries_prov_and_xpath_selectors(
        self, built: tuple[KGStore, FakeProvider, list[dict]]
    ) -> None:
        store, _, _ = built
    ...
    def test_neo4j_plan_is_unwind_merge_batches_and_needs_no_driver(
        self, built: tuple[KGStore, FakeProvider, list[dict]]
    ) -> None:
        store, _, _ = built
        ...
        assert (
            labels.index("page")
            < labels.index("evidence")
            < labels.index("entity")
            < labels.index("mention")
            < labels.index("relation")
        )
        for label, cypher, rows in plan[len(CONSTRAINTS) :]:
            assert (
                cypher.startswith("UNWIND $rows AS r")
                and ("MERGE" in cypher or label == "label")
                and rows
                and len(rows) <= 1000
            )
        ...
        events = list(
            sync_to_neo4j(
                ...
                user="u",
                password="p",
                run=lambda c, rows: ran.append((c[:20], len(rows))),
            )
        )
...
class TestProviders:
    def test_a_preset_key_goes_only_to_the_preset_host(self) -> None:
        ...
        assert ProviderConfig(base_url="https://api.openai.com/v1/").resolve_key(env) == "sk-openai"
        assert (
            ProviderConfig(base_url="https://api.openai.com.evil.example/v1").resolve_key(env)
            is None
        )
    ...
    def test_env_and_presets(self) -> None:
        cfg = ProviderConfig.from_env(
            {"WEBGRAPH_LLM_PROVIDER": "ollama", "WEBGRAPH_LLM_MODEL": "qwen3:8b"}
        )
        assert (cfg.provider, cfg.base_url, cfg.model) == (
            "openai-compatible",
            "http://localhost:11434/v1",
            "qwen3:8b",
        )
        cfg = ProviderConfig.from_env(
            {"WEBGRAPH_LLM_PROVIDER": "anthropic", "WEBGRAPH_LLM_API_KEY_ENV": "MY_KEY"}
        )
        assert cfg.provider == "anthropic" and cfg.resolve_key({"MY_KEY": "sk-1"}) == "sk-1"
        merged = ProviderConfig.from_dict(
            {"provider": "groq", "model": "llama", "api_key": "k"}, base=cfg
        )
    ...
    def test_openai_compatible_falls_back_from_json_schema_to_json_object(self) -> None:
        ...
        provider = OpenAICompatProvider(
            ProviderConfig(model="m", api_key="k", base_url="http://llm.test/v1"),
    ...
    def test_retryable_status_is_retried_and_a_4xx_is_not(
        ...
        def flaky(_: httpx.Request) -> httpx.Response:
            calls["n"] += 1
            return httpx.Response(
                503 if calls["n"] < 3 else 200, json={"choices": [{"message": {"content": "ok"}}]}
            )

        provider = OpenAICompatProvider(
            ProviderConfig(model="m", base_url="http://llm.test/v1"),
    ...
    def test_gemini_request_shape(self) -> None:
        ...
        def handler(request: httpx.Request) -> httpx.Response:
            ...
            return httpx.Response(
                ...
                json={
                    "candidates": [
                        {"content": {"parts": [{"text": '{"entities": [], "relations": []}'}]}}
                    ],
...
class TestCLI:
    ...
    def test_the_flag_gates_every_subcommand(
        ...
        for argv in (
            ["kg", "build", ROOT, "--pages", str(FIXTURE), "--provider", "fake"],
            ["kg", "ask", ROOT, "q"],
            ["kg", "export", ROOT],
            ["kg", "sync-neo4j", ROOT],
        ):
    ...
    def test_build_ask_export(self, env: Path, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        assert (
            main(["kg", "export", ROOT, "--format", "cypher", "--out", str(env / "g.cypher")]) == 0
        )
        assert "MERGE (e:Entity" in (env / "g.cypher").read_text()

    @pytest.mark.usefixtures("env")
    def test_build_needs_a_model_and_ask_needs_a_graph(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        from webgraph.cli import main
    ...
    @pytest.mark.usefixtures("env")
    def test_sync_refuses_a_password_on_the_command_line(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        from webgraph.cli import main
