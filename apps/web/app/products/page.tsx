...
export const metadata: Metadata = {
  title: "Products",
  description:
    "One engine. The crawler, Watch and the CLI are what run today; the rest are what the same output makes possible, and are marked so.",
};
    ...
    <main className="page-col max-md:pb-16 max-md:pt-12 md:pb-24 md:pt-20">
      <header>
        ...
        <p className="measure-lede mt-4 text-body text-muted">
          One engine. The crawler, Watch and the CLI are what run today; the rest are what
          the same output makes possible, and are marked so.
        </p>
      </header>
      ...
      <p className="mt-8 max-w-prose text-caption text-muted">
        ...
        exists yet; the repository today has the crawler, Watch, the API and the CLI.
      </p>
    </main>
  );
}
