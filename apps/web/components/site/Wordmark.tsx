  ...
  return (
    <svg aria-hidden className="mark size-7 shrink-0" viewBox="0 0 24 24">
      <defs>
        ...
        <radialGradient id="mk-n" cx="0.62" cy="0.32" r="0.9">
          <stop offset="0" style={{ stopColor: "var(--brand-hi)" }} />
          <stop offset="1" style={{ stopColor: "var(--brand-b)" }} />
        </radialGradient>
        <filter id="mk-b" x="-60%" y="-60%" width="220%" height="220%"><feGaussianBlur stdDeviation="0.7" /></filter>
        <filter id="mk-w" x="-80%" y="-80%" width="260%" height="260%"><feGaussianBlur stdDeviation="0.7" /></filter>
      </defs>
      <g>
        <path d="M3.00 8.50 L7.50 20.00" fill="none" stroke="url(#mk-g)" strokeWidth="2.7" strokeLinecap="round" />
        <path d="M7.50 20.00 L11.50 12.00" fill="none" stroke="url(#mk-g)" strokeWidth="2.7" strokeLinecap="round" />
        <path d="M11.50 12.00 L15.50 20.00" fill="none" stroke="url(#mk-g)" strokeWidth="2.7" strokeLinecap="round" />
        <path d="M15.50 20.00 L18.11 13.33" fill="none" stroke="url(#mk-g)" strokeWidth="2.7" strokeLinecap="round" />
        <circle cx="3" cy="8.5" r="3.50" style={{ fill: "var(--brand-shade)" }} opacity="0.38" filter="url(#mk-b)" />
        <circle cx="7.5" cy="20.0" r="3.10" style={{ fill: "var(--brand-shade)" }} opacity="0.38" filter="url(#mk-b)" />
        <circle cx="11.5" cy="12.0" r="2.80" style={{ fill: "var(--brand-shade)" }} opacity="0.38" filter="url(#mk-b)" />
        <circle cx="15.5" cy="20.0" r="3.10" style={{ fill: "var(--brand-shade)" }} opacity="0.38" filter="url(#mk-b)" />
        ...
        <path d="M17.40 0.48 Q17.40 6.30 23.22 6.30 Q17.40 6.30 17.40 12.12 Q17.40 6.30 11.58 6.30 Q17.40 6.30 17.40 0.48 Z" style={{ fill: "var(--brand-glow)" }} opacity="0.5" filter="url(#mk-w)" />
