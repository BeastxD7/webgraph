...
A third rule is at page level: if every block of the page is still there and none was
added — the blocks merely sit under different headings — the page is suppressed. Measured
on vtu.ac.in's front page, two static fetches 11 minutes apart put the same social-links
list and the same conference banner under different headings; the page's order jittered,
not its content, and a watch that reported that would be reporting the fetch.
